---
title: "COMPUTO"
subtitle: "Un journal académique en Statistique et Machine-Learrning promouvant la reproductibilité et les modes de publication alternatifs"
...
😱 &darr; de la qualité des publication et du temps consacré à un article
...
**Promouvoir les contributions en statistique et machine-learning permettant d'évaluer la pertinence d'un modèle/d'une méthode vis-à-vis d'une question scientifique spécifique**
:::
...
[![](img/computo_website.png){height=300px}](https://computo.sfsds.asso.fr)
[![](img/computo_github-group.png){height=300px}](https://computorg.github.io)
...
![](img/computo_repo_quarto_extension.png){heitgh=200px}
...
![](img/computo_template_repositories.png)
...
### Step 0: mise en place d'un dépôt git

Clone d'un des [dépôts template (R, Python Julia)](https://github.com/computorg/template-computo-python) pour commencer

### Step 1. Écriture de l'article

À vous de jouer, en local (même esprit qu'en Jupyter/Rmarkdown)

### Step 2: configuration de l'environnement
...
- document HTML et une version PDF sous publiée [sur la github-page associé au dépôt](https://computo.sfds.asso.fr/template-computo-python/)

::: {.highlight-red}
&#8594; Dépôt manuel du PDF et de l'adresse du dépôt git sur <s>Scholastica</s> Open review
:::
...
![](img/computo_template_rendered.png)
...
- Publication des rapports de relecteurs
...
![](img/computo_template_issue_editor.png)
...
🙂 4 workshop présentations in reproducibility workshops (Montpellier, Toronto, Humastica, Grenoble)

🤔 Support institutionnel (projet FNSO): coûteux en temps 
...
- En se proposant **relecteur/relectrice**  <https://forms.gle/P9iYJANuNM4WTVHDA>
...
Logo conçu par [Loïc Schwaller](https://loack.me/)
